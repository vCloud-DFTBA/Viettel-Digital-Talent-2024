...
- Với thông điệp dạng nhị phân thì [Protocol-Buffer](https://protobuf.dev), một định dạng được phát triển bởi google, là một trong những định dạng phổ biến nhất.![Ví dụ về định nghĩa nghĩa một Proto được định nghĩa trong file .pro](attachs/Pasted%20image%2020240527021703.png "Ví dụ về định nghĩa nghĩa một Proto được định nghĩa trong file .pro")
